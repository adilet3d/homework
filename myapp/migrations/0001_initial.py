# Generated by Django 4.1.5 on 2023-01-19 04:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='myapp.bookcategory')),
            ],
        ),
        migrations.AddField(
            model_name='author',
            name='book_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='authors', to='myapp.bookcategory'),
        ),
        migrations.AddField(
            model_name='author',
            name='groups',
